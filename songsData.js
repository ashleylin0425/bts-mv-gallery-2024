...
const songData = {
    ...
    "Spring Day":
    {
        ...
        Others are pictured alone as well, with Jungkook alone on the train, Jimin alone by the sea (again with a shot that shows him as only a tiny fraction of his surroundings), and Namjoon also alone on the train. Namjoon's scene transitions to a hotel with a large Omelas sign, perhaps referencing Omelas as a temporary place that will eventually be left. The inclusion of the train can also be a reference to the use of “snowpiercer” in the lyrics (and it's interesting to note that the film Snowpiercer also has a dark secret related to the suffering of children, like the story of “Omelas.”) 
